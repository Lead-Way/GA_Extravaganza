...
// define a random index from your result
let randomNumber = Math.floor(Math.random() * result.length-1);

// changing title, desc and image based on the random result
document.querySelector(".modal-title").innerText=result[randomNumber].title
document.querySelector(".plot").innerText=result[randomNumber].plot
document.querySelector(".poster").src=result[randomNumber].posterUrl
}
// funtion stops
)
